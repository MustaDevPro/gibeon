...
function css_browser_selector(e) {
  var r = e.toLowerCase(),
    ...
    l = window.devicePixelRatio
      ...
      : "1",
    w = [
      !/opera|webtv/.test(r) && /msie\s(\d+)/.test(r) && (c = 1 * RegExp.$1)
        ? "ie ie" +
          c +
          (6 == c || 7 == c
            ? " ie67 ie678 ie6789"
            ...
            ? " ie9m"
            : "")
        : /trident\/\d+.*?;\s*rv:(\d+)\.(\d+)\)/.test(r) &&
          (c = [RegExp.$1, RegExp.$2])
        ? "ie ie" + c[0] + " ie" + c[0] + "_" + c[1] + " ie9m"
        : /firefox\/(\d+)\.(\d+)/.test(r) && (re = RegExp)
        ? t + " ff ff" + re.$1 + " ff" + re.$1 + "_" + re.$2
        : i("gecko/")
        ? t
        : i(s)
        ? s +
      ...
      i("j2me")
        ? d + " j2me"
        : i("ipad; u; cpu os")
        ? d + " chrome android tablet"
        : i("ipad;u;cpu os")
        ? d + " chromedef android tablet"
        : i("iphone")
        ? d + " ios iphone"
        : i("ipod")
        ? d + " ios ipod"
  ...
  return (
    window.jQuery &&
      ...
      (window.jQuery.browser = c ? { msie: 1, version: c } : {}),
    w
  );
}
!(function (e, r) {
    ...
    !(function (e) {
      function i() {
        if (0 == m) {
          try {
            ...
            if (
              (e > r
                ? u.removeClass(a).addClass(s)
                : u.removeClass(s).addClass(a),
              e == b)
            )
              return;
            b = e;
      ...
      function o() {
        try {
          u.removeClass(p),
            u.addClass(
              360 >= b ? d : 640 >= b ? c : 768 >= b ? l : 1024 >= b ? w : "pc"
            );
        } catch (e) {}
        m = 0;
      }
      ...
      r.CSSBS_ie
        ? setInterval(i, 1e3)
        : e(r).on("resize orientationchange", i).trigger("resize"),
        e(r).load(i);
    })(r.jQuery);
})(document, window);
      ...
      (b.prototype.draw = function () {
        ...
        if (
          ...
          if (
            ...
            this._controls.$indicators.php(d);
          } else
            b > 0
