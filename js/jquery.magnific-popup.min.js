...
(function (e) {
  ...
  (w.prototype = {
    ...
    appendContent: function (e, i) {
      (t.content = e),
        e
          ? t.st.showCloseBtn && t.st.closeBtnInside && t.currTemplate[i] === !0
            ...
            if (n.length > 0) {
              ...
              "replaceWith" === a
                ...
                ? n.is("img")
                  ? n.attr("src", i)
                  : n.replaceWith(
                      '<img src="' + i + '" class="' + n.attr("class") + '" />'
                    )
                : n.attr(o[1], i);
            }
          } else t.find(v + "-" + e).php(i);
        });
    },
      ...
      getInline: function (i, n) {
        if ((L(), i.src)) {
          ...
          if (a.length) {
            ...
            r &&
              r.tagName &&
              (M || ((z = o.hiddenClass), (M = k(z)), (z = "mfp-" + z)),
              (B = a.after(M).detach().removeClass(z))),
            ...
            ? ((r += " mfp-gallery"),
              ...
              x("BuildControls" + n, function () {
                if (t.items.length > 1 && i.arrows && !t.arrowLeft) {
                  var n = i.arrowMarkup,
                    o = (t.arrowLeft = e(
                      n.replace("%title%", i.tPrev).replace("%dir%", "left")
                    ).addClass(y)),
                    r = (t.arrowRight = e(
                      n.replace("%title%", i.tNext).replace("%dir%", "right")
                    ).addClass(y)),
      ...
      (e.fn.mfpFastClick = function (o) {
        ...
        (e.fn.destroyMfpFastClick = function () {
          e(this).off("touchstart" + a + " click" + a),
            i && I.off("touchmove" + a + " touchend" + a);
        });
    })();
