    ...
    menuAnimation: function () {
      $(window).scroll(function () {
        ...
        if (top_v >= 30) {
          ...
          $(".nim-menu.navbar-default .navbar-nav > li > a,a.navbar-brand").css(
            "color",
            "#000"
          );
          ...
          $(".nim-menu.navbar-default .navbar-nav > li > a").css(
            "color",
            "#fafafa"
          );
          $(".nim-menu.navbar-default .navbar-nav > li > a:hover").css(
            "color",
            themecolor
          );
          $(".nim-menu.navbar-default .navbar-nav > li > a").hover(
      ...
      $("#mc-form").submit(function (e) {
        ...
        $.ajax({
          ...
          success: function (data) {
            form.find(".form-message").php(data).fadeIn();
            ...
            if ($(data).is(".send-true")) {
              setTimeout(function () {
                ...
                form
                  ...
                  .delay(500)
                  .queue(function () {
                    form.find(".form-message").php("").dequeue();
                  });
              }, 2000);
            } else {
              form.find(".btn").prop("disabled", false);
