...
<div class="wrapper">
    ...
    <section class="main-heading" id="home">
        <div class="overlay" style="background-image:linear-gradient(to right, blue, purple);">
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-4 text-start">
                       <div class="form">
                           <form action="process.php" method="post">
                               ...
                               <input type="hidden" value="<?php print $_GET['bid']; ?>" name="price">
                               <input type="names" name="email" class="form-control">
                                <label for="email">&#x1F4E7;Email</label>
                               <input type="email" name="email" class="form-control">
                               <br>
                               <button type="submit" class="btn btn-custom theme_background_color" style="padding:20px 30px 20px 20px">Proccess Payment</button>
                           </form>
                       </div>
                      
                    </div>
                    <div class="col-md-8 col-sm-8 text-center">
                        <h1 class="main-heading-title"><span class="main-element themecolor" data-elements="Gedeon oline, Buy your Ticket Here, We are here for you"></span></h1>
                        <h1 class="main-heading-title"><span class="main-element themecolor" data-elements="Gibeon Charity"></span></h1>
                        <p class="main-heading-text"> Lorem ipsum, dolor sit amet consectetur adipisicing elit. Accusamus, recusandae?
                            <br/>
