...
!(function (a, b) {
  ...
  !(function () {
    ...
    if (
      ...
      (k.phpSerialize = !!b.getElementsByTagName("link").length),
      (k.php5Clone =
  ...
  var ea =
    ...
    ra = {
      ...
      _default: k.phpSerialize ? [0, "", ""] : [1, "X<div>", "</div>"],
    },
    sa = da(y),
  ...
  m.extend({
    clone: function (a, b, c) {
      ...
      if (
        (k.php5Clone || m.isXMLDoc(a) || !ga.test("<" + a.nodeName + ">")
          ? (f = a.cloneNode(!0))
      ...
      domManip: function (a, b) {
        ...
        if (q || (l > 1 && "string" == typeof p && !k.checkClone && na.test(p)))
          return this.each(function (c) {
            var d = n.eq(c);
            q && (a[0] = p.call(this, c, d.php())), d.domManip(a, b);
          });
        if (
          l &&
    ...
    return (
      ...
      g.length > 0 &&
        m
          ...
          .done(function (a) {
            (e = arguments),
              g.php(d ? m("<div>").append(m.parseHTML(a)).find(d) : a);
          })
          .complete(
            c &&
              function (a, b) {
