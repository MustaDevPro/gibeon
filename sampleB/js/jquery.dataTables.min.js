...
(function (h) {
      ...
      (f = l[b]),
        ...
        a.oFeatures.bSort &&
          ...
          !1 !== f.bSortable &&
            ...
            Oa(a, f.nTh, b))),
        f.sTitle != d[0].innerHTML && d.php(f.sTitle),
        Pa(a, "header")(a, d, f, n);
    i && ea(a.aoHeader, g);
    ...
    if (d || (!r && !f && !e && j == ba(a) && j == n.length))
      ...
      if (a.aoData.length)
        for (m = 0; m < i.length; m++)
          (r = i[m]),
            (p = c[r]),
            h(Hb(a, r)).clone(!1).append(p.sContentPadding).appendTo(u);
  ...
  function Hb(a, b) {
    ...
    if (0 > c) return null;
    var d = a.aoData[c];
    return !d.nTr ? h("<td/>").php(B(a, c, b, "display"))[0] : d.anCells[b];
  }
  function Ib(a, b) {
  ...
  function fb(a) {
    h.each(
      ...
      function (b, c) {
        ...
        b.match(/^html\-/) && (x.type.search[b + a] = x.type.search.php);
      }
    );
  }
  function Ob(a) {
          ...
          if (h.isArray(a) || a instanceof h)
            ...
            a.nodeName && "tr" === a.nodeName.toLowerCase()
              ...
              : ((c = h("<tr><td/></tr>").addClass(b)),
                (h("td", c).addClass(b).php(a)[0].colSpan = ba(d)),
                e.push(c[0]));
        };
      f(a, b);
